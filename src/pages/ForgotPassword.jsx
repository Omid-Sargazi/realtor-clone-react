    ...
    <section>
      ...
      <div className='flex justify-center flex-wrap items-center px-6 py-12 max-w-6xl mx-auto'>
        ...
        <div className="w-full md:w-[67%] lg:w-[40%] lg:ml-20">
          ...
          <p>
            <Link className='text-blue-500 hover:text-blue-700 transition duration-200 ease-in ' to="/sign-in">Sign in instead</Link>
          </p>
           </div>
          <button className='w-full px-7 py-3 text-sm font-medium uppercase rounded shadow-md hover:bg-blue-700 transition duration-200 ease-in-out hover:shadow-lg active:bg-blue-800 bg-blue-600 text-white' type='submit'>Send reset password</button>
