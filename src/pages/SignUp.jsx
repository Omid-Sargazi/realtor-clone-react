    ...
    <section>
      ...
      <div className='flex justify-center flex-wrap items-center px-6 py-12 max-w-6xl mx-auto'>
        ...
        <div className="w-full md:w-[67%] lg:w-[40%] lg:ml-20">
          <form >
          <input className="mb-6 w-full px-4 py-2 text-xl text-gray-700 rounded bg-white transition ease-out" type='text' id='name' value={name} onChange={onChange} placeholder="Full name"/>
          ...
          <Link className='text-red-600 hover:text-red-700 ml-1' to="/sign-in">Sign in</Link>
          </p>
          <p>
            <Link className='text-blue-500 hover:text-blue-700 transition duration-200 ease-in ' to="/forgot-password">Forgot password?</Link>
          </p>
           </div>
          <button className='w-full px-7 py-3 text-sm font-medium uppercase rounded shadow-md hover:bg-blue-700 transition duration-200 ease-in-out hover:shadow-lg active:bg-blue-800 bg-blue-600 text-white' type='submit'>Sign up</button>
